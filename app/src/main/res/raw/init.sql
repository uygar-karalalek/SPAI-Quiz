...
INSERT INTO question values(null, 4, 2, "Quale funzione, in Kotlin, ti permette di creare una mappa mutabile con oggetti di tipo T?", "mapOf<T>()", "mutableMapOf<T>()", "Map.of<T>()", "Collections.mapOf<T>()", null, 30);
...
INSERT INTO question values(null, 4, 3, "Quale di questi algoritmi è spiegato nel video?", "Apple sort", "Min sort", "Bubble sort", "Hexagon sort", "bubble", 30);
INSERT INTO question values(null, 4, 3, "Quale di questi algoritmi è spiegato nel video?", "Merge sort", "Linear search", "Quick sort", "Binary search", "quick", 30);
